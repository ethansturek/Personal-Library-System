...
public class ScrollAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scroll_add);
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(ScrollAdd.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(ScrollAdd.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        BookAdapter adapter = new BookAdapter(bookInfoArrayList, ScrollAdd.this);
                    ...
                    Toast.makeText(ScrollAdd.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ScrollAdd.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
